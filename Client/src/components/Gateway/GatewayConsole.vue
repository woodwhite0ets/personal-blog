    ...
    <main v-else class="main-layout">
      ...
      <section class="content">
        ...
        <section v-else-if="view === 'projects'" class="view-stack">
          <div class="toolbar"><p class="muted">文档保存后会自动触发索引。</p><button class="btn-primary" @click="createProject">新建知识库</button></div>
