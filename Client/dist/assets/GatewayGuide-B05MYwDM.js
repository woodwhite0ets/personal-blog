import{E as e,I as t,M as n,O as r,S as i,b as a,it as o,m as s,ot as c,p as l,r as u,s as d,u as f,v as p,w as m}from"./runtime-core.esm-bundler-BWcqDh2G.js";import{t as h}from"./ThemeSwitcher-84hNkViH.js";import{t as g}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as _}from"./SiteFooter-TQXbpXou.js";import{n as v,t as y}from"./purify.es-CsIMUqjE.js";function b(e){return typeof e==`string`?e.replace(/^\uFEFF/,``).replace(/^---\s*\n[\s\S]*?\n(?:---|\.\.\.)\s*\n?/,``):e}function x(e){return!e||typeof e!=`string`?``:y.sanitize(v.parse(b(e)),{FORBID_ATTR:[`style`,`id`,`name`]})}var S=`# Gateway 使用文档
