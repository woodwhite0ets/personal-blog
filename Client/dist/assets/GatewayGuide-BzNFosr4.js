import{E as e,L as t,N as n,O as r,S as i,at as a,b as o,m as s,p as c,r as l,s as u,st as d,u as f,v as p,w as m}from"./runtime-core.esm-bundler-BbGVVqWE.js";import{t as h}from"./ThemeSwitcher-Cp44wFia.js";import{t as g}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as _}from"./SiteFooter-CB0L6lI9.js";import{n as v,t as y}from"./purify.es-CsIMUqjE.js";function b(e){return typeof e==`string`?e.replace(/^\uFEFF/,``).replace(/^---\s*\n[\s\S]*?\n(?:---|\.\.\.)\s*\n?/,``):e}function x(e){return!e||typeof e!=`string`?``:y.sanitize(v.parse(b(e)),{FORBID_ATTR:[`style`,`id`,`name`]})}var S=`# Gateway 使用文档
...
`,C={class:`gateway-page gateway-guide-page`},w={class:`navbar`},T={class:`navbar-inner`},E={class:`nav-actions`},D={class:`guide-layout`},O={class:`guide-sidebar terminal-panel`},k={class:`guide-nav`,"aria-label":`文档目录`},A=[`href`,`data-section-id`],j={class:`terminal-panel guide-panel`},M=[`innerHTML`],N=g({__name:`GatewayGuide`,setup(g){let v=t([]),y=t(``),b;function N(e){return String(e||``).trim().toLowerCase().replace(/\./g,``).replace(/\s+/g,`-`).replace(/[^\w一-龥-]/g,``).replace(/-+/g,`-`)}let P=t(``);function F(){let e=x(S);if(typeof DOMParser>`u`){P.value=e,v.value=[];return}let t=new DOMParser().parseFromString(e,`text/html`),n=Array.from(t.querySelectorAll(`h1, h2`)).map(e=>{let t=N(e.textContent);return e.id=t,{id:t,label:e.textContent.trim()}});v.value=n,y.value=n[0]?.id??``,P.value=t.body.innerHTML}function I(e){e.preventDefault();let t=e.currentTarget.dataset.sectionId,n=t?document.getElementById(t):null;n&&(y.value=t,n.scrollIntoView({behavior:`smooth`,block:`start`}),history.replaceState(null,``,`#${encodeURIComponent(t)}`))}function L(){let e=window.location.hash.slice(1);if(!e)return``;try{return decodeURIComponent(e)}catch{return e}}function R(){let e=L();if(!e)return;let t=document.getElementById(e);t&&(y.value=e,t.scrollIntoView({behavior:`auto`,block:`start`}))}function z(){let e=v.value.map(e=>document.getElementById(e.id)).filter(Boolean);if(!e.length)return;let t=window.innerHeight+window.scrollY>=document.documentElement.scrollHeight-8?e.at(-1):e.filter(e=>e.getBoundingClientRect().top<=120).at(-1);y.value=(t??e[0]).id}function B(){b||=window.requestAnimationFrame(()=>{b=void 0,z()})}return i(async()=>{F(),await p(),R(),z(),window.addEventListener(`scroll`,B,{passive:!0})}),o(()=>{window.removeEventListener(`scroll`,B),b&&window.cancelAnimationFrame(b)}),(t,i)=>{let o=r(`router-link`);return m(),f(`div`,C,[i[6]||=u(`div`,{class:`bg-grid`},null,-1),i[7]||=u(`div`,{class:`bg-scanline`},null,-1),u(`header`,w,[u(`div`,T,[s(o,{to:`/gateway`,class:`brand`},{default:n(()=>[...i[0]||=[u(`span`,{class:`brand-bracket`},`[`,-1),u(`span`,{class:`brand-text`},`woodwhite@blog`,-1),u(`span`,{class:`brand-bracket`},`]`,-1),u(`span`,{class:`brand-path`},`~/gateway/docs`,-1)]]),_:1}),u(`div`,E,[s(h),i[1]||=u(`span`,{class:`gateway-badge`},`MCP DOCUMENTATION`,-1),i[2]||=u(`a`,{href:`/HomePage`,class:`nav-link`},`返回博客`,-1)])])]),u(`main`,D,[u(`aside`,O,[i[4]||=u(`div`,{class:`panel-bar`},[u(`span`,{class:`panel-dot dot-cyan`}),u(`span`,{class:`panel-dot dot-cyan dim`}),u(`span`,{class:`panel-title`},`docs.index`)],-1),u(`nav`,k,[(m(!0),f(l,null,e(v.value,e=>(m(),f(`a`,{key:e.id,href:`#`+e.id,"data-section-id":e.id,class:a({active:y.value===e.id}),onClick:I},d(e.label),11,A))),128))]),s(o,{to:`/gateway`,class:`btn btn-secondary guide-back`},{default:n(()=>[...i[3]||=[c(`返回 Gateway`,-1)]]),_:1})]),u(`article`,j,[i[5]||=u(`div`,{class:`panel-bar`},[u(`span`,{class:`panel-dot dot-cyan`}),u(`span`,{class:`panel-dot dot-cyan dim`}),u(`span`,{class:`panel-title`},`cat docs/USAGE.md`)],-1),u(`div`,{class:`guide-content markdown-body`,innerHTML:P.value},null,8,M)])]),s(_,{command:`cat docs/USAGE.md`})])}}},[[`__scopeId`,`data-v-53dcd2f1`]]);export{N as default};