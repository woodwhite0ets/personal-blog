import{E as e,I as t,M as n,O as r,S as i,b as a,it as o,m as s,ot as c,p as l,r as u,s as d,u as f,v as p,w as m}from"./runtime-core.esm-bundler-BWcqDh2G.js";import{t as h}from"./ThemeSwitcher-r1Gz0HQQ.js";import{t as g}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as _}from"./SiteFooter-TQXbpXou.js";import{n as v,t as y}from"./purify.es-CsIMUqjE.js";function b(e){return!e||typeof e!=`string`?``:y.sanitize(v.parse(e),{FORBID_ATTR:[`style`,`id`,`name`]})}var x=`# Gateway 使用文档
...
`,S={class:`gateway-page gateway-guide-page`},C={class:`navbar`},w={class:`navbar-inner`},T={class:`nav-actions`},E={class:`guide-layout`},D={class:`guide-sidebar terminal-panel`},O={class:`guide-nav`,"aria-label":`文档目录`},k=[`href`,`data-section-id`],A={class:`terminal-panel guide-panel`},j=[`innerHTML`],M=g({__name:`GatewayGuide`,setup(g){let v=t([]),y=t(``),M;function N(e){return String(e||``).trim().toLowerCase().replace(/\./g,``).replace(/\s+/g,`-`).replace(/[^\w一-龥-]/g,``).replace(/-+/g,`-`)}let P=t(``);function F(){let e=b(x);if(typeof DOMParser>`u`){P.value=e,v.value=[];return}let t=new DOMParser().parseFromString(e,`text/html`),n=Array.from(t.querySelectorAll(`h1, h2`)).map(e=>{let t=N(e.textContent);return e.id=t,{id:t,label:e.textContent.trim()}});v.value=n,y.value=n[0]?.id??``,P.value=t.body.innerHTML}function I(e){e.preventDefault();let t=e.currentTarget.dataset.sectionId,n=t?document.getElementById(t):null;n&&(y.value=t,n.scrollIntoView({behavior:`smooth`,block:`start`}),history.replaceState(null,``,`#${encodeURIComponent(t)}`))}function L(){let e=window.location.hash.slice(1);if(!e)return``;try{return decodeURIComponent(e)}catch{return e}}function R(){let e=L();if(!e)return;let t=document.getElementById(e);t&&(y.value=e,t.scrollIntoView({behavior:`auto`,block:`start`}))}function z(){let e=v.value.map(e=>document.getElementById(e.id)).filter(Boolean);if(!e.length)return;let t=window.innerHeight+window.scrollY>=document.documentElement.scrollHeight-8?e.at(-1):e.filter(e=>e.getBoundingClientRect().top<=120).at(-1);y.value=(t??e[0]).id}function B(){M||=window.requestAnimationFrame(()=>{M=void 0,z()})}return i(async()=>{F(),await p(),R(),z(),window.addEventListener(`scroll`,B,{passive:!0})}),a(()=>{window.removeEventListener(`scroll`,B),M&&window.cancelAnimationFrame(M)}),(t,i)=>{let a=r(`router-link`);return m(),f(`div`,S,[i[6]||=d(`div`,{class:`bg-grid`},null,-1),i[7]||=d(`div`,{class:`bg-scanline`},null,-1),d(`header`,C,[d(`div`,w,[s(a,{to:`/gateway`,class:`brand`},{default:n(()=>[...i[0]||=[d(`span`,{class:`brand-bracket`},`[`,-1),d(`span`,{class:`brand-text`},`woodwhite@blog`,-1),d(`span`,{class:`brand-bracket`},`]`,-1),d(`span`,{class:`brand-path`},`~/gateway/docs`,-1)]]),_:1}),d(`div`,T,[s(h),i[1]||=d(`span`,{class:`gateway-badge`},`MCP DOCUMENTATION`,-1),i[2]||=d(`a`,{href:`/HomePage`,class:`nav-link`},`返回博客`,-1)])])]),d(`main`,E,[d(`aside`,D,[i[4]||=d(`div`,{class:`panel-bar`},[d(`span`,{class:`panel-dot dot-cyan`}),d(`span`,{class:`panel-dot dot-cyan dim`}),d(`span`,{class:`panel-title`},`docs.index`)],-1),d(`nav`,O,[(m(!0),f(u,null,e(v.value,e=>(m(),f(`a`,{key:e.id,href:`#`+e.id,"data-section-id":e.id,class:o({active:y.value===e.id}),onClick:I},c(e.label),11,k))),128))]),s(a,{to:`/gateway`,class:`btn btn-secondary guide-back`},{default:n(()=>[...i[3]||=[l(`返回 Gateway`,-1)]]),_:1})]),d(`article`,A,[i[5]||=d(`div`,{class:`panel-bar`},[d(`span`,{class:`panel-dot dot-cyan`}),d(`span`,{class:`panel-dot dot-cyan dim`}),d(`span`,{class:`panel-title`},`cat docs/USAGE.md`)],-1),d(`div`,{class:`guide-content markdown-body`,innerHTML:P.value},null,8,j)])]),s(_,{command:`cat docs/USAGE.md`})])}}},[[`__scopeId`,`data-v-5d586dd0`]]);export{M as default};